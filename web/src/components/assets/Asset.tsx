...
import { Box, Card, Avatar, CardContent, CardProps } from '@material-ui/core';
//
...
interface AssetProps extends CardProps {
  asset: SingleAsset;
}

export default function Asset({ asset, sx }: AssetProps) {
    ...
    >
      <CardMediaStyle>
        ...
        <RouterLink to={`/${owner.username}`}>
          <AvatarStyle alt={owner.username} src={owner.avatar} />
        </RouterLink>
      ...
      <CardContent sx={{ pt: 4 }}>
        ...
        <InfoStyle>
          <LikeButton id={id} likedByMe={likedByMe} likes={likes} sx={{ paddingLeft: '5px' }} />
